...
grid on
xlim([0 0.3])
xlabel('MI privacy $\rho$','Interpreter','latex')
ylabel('Download cost $D$','Interpreter','latex')
legend("TSC (without p#)", "Optimized reduced WPIR#", "WPIR# - optimized for homogeneity", "Numerically optimized WPIR#")
